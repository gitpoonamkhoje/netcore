...
var host = new HostBuilder()
    ...
    .ConfigureServices((context, services) =>
    {
        ...
        services.AddSingleton<IFileShareReader, FileShareReader>();
        services.AddSingleton<ISqlBulkFormatFileParser, SqlBulkFormatFileParser>();
        services.AddSingleton<ITabLoadService, TabLoadService>();
    })
    .Build();
